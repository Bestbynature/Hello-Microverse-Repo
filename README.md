...
**[Hello Microverse Project]** is my first project to check if i can successfully create a professional-looking pull request
...
- **[Learning to set up linters]**
- **[Attempting Pull Requests]**
- **[Learning how .gitignore files work]**
...
I would like to thank the entire Microverse Team for making this project a reality
